...
export default function EQPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFAF7] text-gray-700 font-sans antialiased selection:bg-rose-100 py-2.5 space-y-3 px-2 w-full">
      
      {/* 1. イントロ・ヘッダーセクション */}
      <section className="w-full space-y-1.5 text-gray-700 leading-relaxed rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm">
        {/* Header */}
        <div className="text-center space-y-1 mb-4 p-1">
          <span className="text-xs font-bold tracking-wider text-rose-400 uppercase block md:text-sm">
            About EQ Method
          </span>
          <h1 className="text-lg font-black text-gray-900 sm:text-xl md:text-2xl leading-snug">
            大阪梅田でハクラス婚活・スピード成婚なら［大阪梅田ドクターズ結婚相談所］｜現役医師監修×仲人歴20年
          </h1>
          <div className="mx-auto mt-1 h-0.5 w-16 bg-rose-400" />
        </div>

        {/* Content - 16px (text-base) spacing tight but comfortable */}
        <div className="text-base text-gray-700 leading-relaxed font-normal tracking-wide space-y-3.5 w-full">
          <div className="bg-slate-50 border border-slate-100 p-3 rounded-lg text-center space-y-1.5 w-full">
          ...
          <p className="text-base w-full px-1">
      ...
      {/* 2. 女医からの一言 (Alert Box) */}
      <section className="w-full rounded-xl border border-rose-150 bg-rose-50/40 p-3.5 shadow-sm space-y-2.5">
        <div className="flex items-center gap-1.5 border-b border-rose-100 pb-2">
          <span className="text-xl">👩‍⚕️</span>
          <h2 className="text-base font-black text-rose-600 sm:text-lg leading-snug">
            女医からの一言 🩷
          </h2>
        </div>

        <div className="text-base text-gray-700 leading-relaxed font-normal tracking-wide space-y-3 w-full">
          <p className="font-bold text-gray-900 px-1">
          ...
          <p className="text-sm text-gray-500 border-t border-rose-100 pt-2 px-1">
      ...
      {/* 3. 4つのコアパラメータ */}
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3.5">
        ...
        {/* High Density Edge-To-Edge Items */}
        <div className="text-base text-gray-700 leading-relaxed space-y-4 w-full">
          
          {/* Skill 1 */}
          <div className="space-y-1.5 border-b border-rose-50/60 pb-3 w-full">
            <h3 className="font-black text-gray-900 text-base sm:text-lg flex items-center gap-2 px-1">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-rose-500 text-white font-mono text-xs shrink-0 font-bold">1</span>
              自分の感情を認識する力（Emotional Self-Awareness）
            </h3>
            <p className="text-base text-gray-600 pl-4 pr-1">
              <strong>専門的な解説：</strong>自分が「なぜ今イライラしているのか」「何を不安に思っているのか」を、把握する能力です。自分の感情の原因がわからないと解決も難しくなります。
            </p>
            <div className="bg-rose-50/40 p-2.5 rounded-lg border border-rose-100/30 text-sm font-medium text-rose-700 pl-6 relative">
          ...
          <div className="space-y-1.5 border-b border-rose-50/60 pb-3 w-full">
            <h3 className="font-black text-gray-900 text-base sm:text-lg flex items-center gap-2 px-1">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-rose-500 text-white font-mono text-xs shrink-0 font-bold">2</span>
          ...
          <div className="space-y-1.5 border-b border-rose-50/60 pb-3 w-full">
            <h3 className="font-black text-gray-900 text-base sm:text-lg flex items-center gap-2 px-1">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-rose-500 text-white font-mono text-xs shrink-0 font-bold">3</span>
              他者へ共感する力（Empathy）
            </h3>
            <p className="text-base text-gray-600 pl-4 pr-1">
              <strong>専門的な解説：</strong>相手の言葉の裏にある「感情」や「状況」を、自分の価値観にとらわれずに受け入れ、共感する力です。
            </p>
            <div className="bg-rose-50/40 p-2.5 rounded-lg border border-rose-100/30 text-sm font-medium text-rose-700 pl-6 relative space-y-1.5 w-full">
              <span className="absolute left-2 text-rose-400">➡️</span>
              <strong>共感する力を高める方法（反復傾聴）：</strong>
              <p className="pl-1">・相手が悩みや相談を話した際、すぐに「こうすればいいのに」と解決策（アドバイス）を提示するのを我慢します。</p>
              <p className="pl-1">・まずは「それは大変だったね」「そんなことがあったら悔しいよね」と、相手の言葉を反復し、感情を受け止めます。相手は「この人は私を理解してくれる」と安心感を抱くようになります。</p>
            </div>
          </div>
          ...
          <div className="space-y-1.5 w-full">
            <h3 className="font-black text-gray-900 text-base sm:text-lg flex items-center gap-2 px-1">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-rose-500 text-white font-mono text-xs shrink-0 font-bold">4</span>
            ...
            <div className="bg-rose-50/40 p-2.5 rounded-lg border border-rose-100/30 text-sm font-medium text-rose-700 pl-6 relative space-y-1.5 w-full">
              ...
              <p className="pl-1">アサーティブな会話とは、「相手のことも自分のことも、どちらも同じように大切にする」誠実で対等な対話術のことです。</p>
              <p className="pl-1">自分の意見を無理に押し通すのでもなく、逆に言いたいことを我慢して相手に合わせるのでもない、お互いにとって心地よい着地点を見つけるための大人のコミュニケーションを指します。異なる価値観を持つ二人が長く一緒に暮らす上で、最も重要とされる心の知能指数（EQ）のスキルです。</p>
              <p className="pl-1 text-gray-500 font-normal">・「どうせ言っても無駄だ」と我慢したり、逆に感情的に攻撃したりせず、共通のゴールを目指して話し合いましょう。伝える習慣から始まります。</p>
            </div>
          </div>
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3.5">
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-3.5 w-full">
          <p className="text-base text-gray-600 px-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
            {/* 女性 */}
            <div className="bg-white rounded-xl p-3 border border-rose-100/50 shadow-xs space-y-1.5 w-full">
          ...
          {/* Q&A */}
          <div className="p-3 bg-slate-900 text-slate-100 rounded-lg space-y-2.5 w-full">
            <h5 className="font-bold text-amber-300 text-sm sm:text-base">
              ❓ 問い：なぜこの違い【傾向】が生まれるのか？
            </h5>
            <div className="text-sm leading-relaxed text-slate-300 space-y-2 border-t border-slate-800 pt-2 px-0.5">
              <p>
          ...
          <div className="bg-rose-50/50 rounded-lg p-3 border border-rose-100/30 space-y-1 w-full">
            <p className="font-bold text-rose-600 text-sm px-0.5">👩‍⚕️ 女性医師の見解：</p>
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3">
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-3 w-full px-1">
          <p className="font-bold text-gray-900 border-b border-rose-50 pb-2">
          ...
          <p className="text-sm text-rose-600 bg-rose-50/50 p-2.5 rounded-lg text-center font-bold border border-rose-100/40 w-full">
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3">
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-3 w-full px-1">
          ...
          {currentQuestion === null && !quizFinished ? (
            ...
            <div className="space-y-3.5 w-full p-3 bg-white rounded-lg border border-rose-50 shadow-xs">
              ...
              <div className="space-y-1.5 pt-1">
                {quizQuestions[currentQuestion].options.map((opt, idx) => (
                  <button
                    ...
                    className="w-full text-left p-2.5 rounded-lg border border-gray-200 hover:border-rose-300 hover:bg-rose-50/30 text-sm font-medium transition text-gray-700 leading-snug"
                  >
                    {opt.text}
                  </button>
                ))}
            ...
            <div className="text-center space-y-3 w-full p-4 bg-rose-50/20 rounded-lg border border-rose-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed text-left bg-white p-3 rounded-lg border border-rose-100/50">
              ...
              <button
                onClick={resetQuiz}
                className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-500 hover:text-gray-800 transition pt-1"
              >
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-4">
        <div className="text-center space-y-1">
          <span className="text-xs font-bold tracking-wider text-rose-400 uppercase block md:text-sm">
            Background Theory
          </span>
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-5 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            <div className="space-y-1.5">
              ...
              <p className="text-base text-gray-600 pl-3">
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3.5">
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-3.5 w-full px-1">
          <p className="text-sm text-gray-500 text-center">
            心理医学の世界的権威であるルーヴェン・バーオン氏は、EQを測定可能なモデルとして発展させ、15の詳細なパラメーター（要素）に分類しました。これらは結婚生活を円満に維持するための「人間力のカルテ」となります。
          </p>

          {/* Grid with subtle inner padding */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 w-full pt-1">
            
            {/* 自己領域 */}
            <div className="bg-white rounded-xl p-3 border border-rose-50 shadow-2xs space-y-1.5 w-full">
              <h4 className="font-bold text-rose-500 text-sm sm:text-base border-b border-rose-50 pb-1.5">
                ① 自己領域（インサイド）
              </h4>
            ...
            <div className="bg-white rounded-xl p-3 border border-rose-50 shadow-2xs space-y-1.5 w-full">
              ...
              <ul className="text-xs text-gray-600 space-y-1 pl-1">
                ...
                <li><strong>7. 対人関係力:</strong> 心地よい距離で親密な関係を維持するスキル。</li>
            ...
            <div className="bg-white rounded-xl p-3 border border-rose-50 shadow-2xs space-y-1.5 w-full">
              ...
              <ul className="text-xs text-gray-600 space-y-1 pl-1">
                ...
                <li><strong>15. 幸福感:</strong> 日常の些細な出来事に満足と感謝を見出す力。</li>
              </ul>
            </div>

          </div>

          <div className="bg-rose-50 border border-rose-100 rounded-xl p-3 text-sm text-gray-700 leading-relaxed w-full">
      ...
      <section className="w-full rounded-xl border border-rose-100 bg-gradient-to-b from-white to-[#FAF8F5]/40 p-3.5 shadow-sm space-y-3.5">
        ...
        <div className="text-base text-gray-700 leading-relaxed space-y-3.5 w-full">
          <p className="font-bold text-gray-900 border-l-4 border-rose-400 pl-3.5">
            大阪梅田ドクターズ結婚相談所からの一言🩷💙
          </p>

          <p className="text-base text-gray-600 w-full px-1">
          ...
          <div className="pt-1.5 text-center w-full">
            <a
              href="#contact"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white font-bold px-8 py-3 rounded-xl shadow-md transition duration-300 text-base w-full sm:w-auto"
            >
      ...
      {/* フッター */}
      <footer className="text-center py-4 text-xs text-gray-400 border-t border-rose-50 mt-4 w-full">
