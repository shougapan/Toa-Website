...
export default function MembershipSteps() {
  ...
  <div className="mx-auto px-5 py-6 sm:py-16 space-y-2">
    ...
    <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
      ...
      <p>
        客観的な分析、そして20年の最前線で培った男性仲人としての実践的な戦略。これらを駆使し、お一人おひとりの人生に深くコミットするため、当相談所では
  ...
  <div className="mx-auto px-5 py-6 sm:py-16 space-y-2">
    ...
    <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
      ...
      <p>
        ...
        まずは公式LINEから、あなたのペースでお悩みや現在の状況をお聞かせください。
      </p>

      <p>
        <span className="font-black text-gray-900">安心：</span>
        ベテランカウンセラーが、完全個別で丁寧に直接お答えします。
      </p>
