...
export default function MembershipSteps() {
  return (
    <div>
      <section className="w-[98%] mx-auto rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-blue-50 p-8 sm:p-2 space-y-8">
...
<section className="w-[98%] mx-auto rounded-3xl border border-pink-100 bg-gradient-to-br from-pink-50 via-white to-blue-50 shadow-sm px-6 py-6 lg:px-8 lg:py-8">
  ...
  <div className="mt-5 space-y-5 text-lg leading-9 text-gray-700 w-full">

    <p>
      私たちが求めているのは、完璧なスペックを持った方ではありません。
    </p>

    <div className="rounded-2xl bg-white border border-pink-100 px-6 py-5 shadow-sm">
      <p className="text-xl lg:text-2xl font-black text-pink-600 leading-relaxed">
