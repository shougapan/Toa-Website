...
export default function MobileFirstMarriagePage(): React.JSX.Element {
  ...
  return (
    <div className="w-full max-w-xl mx-auto p-3 bg-white text-gray-900 font-sans leading-relaxed tracking-tight text-xs sm:text-sm antialiased">
...
<section className="mb-6 space-y-2">
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 1</span>
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 2</span>
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 3</span>
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 4</span>
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 5</span>
        ...
        <div className="border border-gray-200 p-2 rounded bg-white">
          <div className="flex items-baseline space-x-1 mb-0.5">
            <span className="bg-pink-600 text-white text-[9px] font-bold px-1 rounded">STEP 6</span>
      ...
      <div className="border-t border-gray-300 pt-3 space-y-5">
        ...
        <div ref={step1Ref} className="scroll-mt-3">
          <div className="p-2.5 border border-pink-100 bg-white rounded space-y-2 text-justify">
            ...
            <p>
              テンプレートに当てはめるだけの自己紹介文では、無難な人しか集まりません。あなたの理想のパートナーに出会えための、戦略的なアプローチを行います。「文章を書くのが苦手」「自分の強みが分からない」という方はカウンセラーによる「自己紹介文」のオーダーメイド作成もおまかせ下さい。大阪梅田結婚相談所では、じっくり行うインタビュー（ヒアリング）を基に、プロの婚活カウンセラー（仲人）が素敵な自己紹介文を完成させます。
            </p>
            <div className="pt-1">
            ...
            <p className="font-bold text-center text-pink-600 pt-1 text-[11px]">一緒に素敵なプロフィールを作成しましょう。</p>
          </div>
        </div>
...
💙【男性編】</p>
            ...
            <div className="bg-gray-50 p-2 rounded border space-y-1.5 text-[11px]">
        ...
        <div ref={step4Ref} className="scroll-mt-3">
          <div className="p-2.5 border border-gray-200 bg-white rounded space-y-2 text-justify">
            ...
            <p>
              結婚相談所の婚活で、最も明暗を分けるのが「仮交際」の期間です。「友達以上、恋人未満」のこの時期は、複数のお相手とデートができる半面、「誰を選べばいいの？」「デートの頻度は？」「相手はどう思っている？」など、一番悩みや迷いが生じやすい期間でもあります。大阪梅田結婚相談所では、LINEや電話にて、お悩みにリアルタイムで並走します。
            </p>
            ...
            <div className="bg-pink-50 p-2 rounded border border-pink-200 text-center font-bold text-[10px] sm:text-[11px] text-pink-800">
        ...
        <div ref={step5Ref} className="scroll-mt-3">
          ...
          <div className="p-2.5 border border-gray-200 bg-white rounded space-y-2 text-justify">
            ...
            <h2 className="text-xs font-bold text-gray-800 bg-gray-50 p-1 border rounded">
              ## 大阪梅田で確実にプロポーズを成功させる｜「女医×ベテラン」の真剣交際・成婚プロデュース
            </h2>
            
            <p>
              真剣交際に進んだからといって、100%成婚できるわけではありません。実は、「結婚後の具体的な生活イメージのズレ」や「ご家族との関係」などによって、最終段階で交際が終了してしまうケースが婚活業界では少なくありません。大阪梅田結婚相談所では、そんな「成婚直前の不安や迷い」をなくし、お二人がスムーズに結婚へと歩めるよう、バックアップします。
            </p>
