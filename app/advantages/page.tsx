  ...
  return (
    <div className="bg-[#FAF8F5] text-gray-950 min-h-screen pb-12 font-medium text-lg w-full overflow-x-hidden">
      ...
      <div className="w-full pt-8 pb-6 text-center bg-white border-b border-gray-100 px-4">
        ...
        <div className="w-16 h-1 bg-gradient-to-r from-[#89D1D5] to-[#F5A3B8] mx-auto mt-4 rounded-full" />
      </div>
      ...
      <div className="w-full mb-8 sm:px-4 sm:mt-6">
        <div className="bg-white w-full max-w-4xl mx-auto p-5 sm:p-6 shadow-[0_6px_30px_rgba(0,0,0,0.04)] border-2 border-[#89D1D5]/40 rounded-3xl">
          ...
          <h2 className="text-base font-black text-black tracking-wider uppercase mb-2 flex items-center gap-2">
            <HelpCircle className="w-4 h-4 text-[#89D1D5]" />
            👇 気になるテーマからご覧ください
          </h2>
            ...
            <div className="rounded-2xl border border-[#89D1D5]/50 bg-gradient-to-r from-[#89D1D5]/10 to-white p-5 shadow-sm">
              ...
              <div className="mt-6 flex justify-end">
                ...
                <button
                  ...
                  className="group inline-flex min-w-[260px] justify-center items-center gap-2 rounded-xl bg-[#89D1D5] hover:bg-[#72c2c6] px-6 py-3.5 text-base font-black text-white shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-xl active:scale-95"
                >
                  📖 成婚のヒントを読む
            ...
            <div className="rounded-2xl border border-[#F5A3B8]/50 bg-gradient-to-r from-[#F5A3B8]/10 to-white p-5 shadow-sm">
              ...
              <div className="mt-6 flex justify-end">
                ...
                <button
                  ...
                  className="group inline-flex min-w-[260px] justify-center items-center gap-2 rounded-xl bg-[#F5A3B8] hover:bg-[#e88ba2] px-6 py-3.5 text-base font-black text-white shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-xl active:scale-95"
                >
                  💗 女医からのメッセージ
                  <ChevronRight className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" />
                </button>
      ...
      <div ref={section2Ref} className="w-full mb-8 sm:px-4">
        <div className="max-w-4xl mx-auto bg-gradient-to-b from-white to-[#F5A3B8]/10 w-full p-4 sm:p-6 shadow-sm border-y sm:border border-[#F5A3B8]/30 sm:rounded-3xl border-l-4 border-l-[#F5A3B8]">
          ...
          {/* Letter Container - フォントサイズはスマホでも16px（text-base）を維持 */}
          <div className="text-base text-gray-700 leading-relaxed tracking-wide">

            {/* Profile Image - スマホ・PC共通で常に左にフロート（左寄せ） */}
            {/* スマホ(w-24: 96px) / タブレット以上(sm:w-32: 128px) / デスクトップ(md:w-40: 160px) */}
